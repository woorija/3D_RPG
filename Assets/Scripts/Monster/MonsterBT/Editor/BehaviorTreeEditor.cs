...
public class BehaviorTreeEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (showFoldout)
        {
            ...
            CustomEditorUtility.DrawCenteredText("메인 노드 선택");
            ...
            CustomEditorUtility.DrawLine();
            CustomEditorUtility.DrawCenteredText("템플릿 선택");

            EditorGUILayout.BeginHorizontal();
            CustomEditorUtility.DrawButtonStyleToggle("기본 로직", null, (int)NodeList.BaseLogic, ref selectedIndex);
            EditorGUILayout.EndHorizontal();
            ...
            CustomEditorUtility.DrawButton("SetUp RootNode", () => SetUpRootNode());

            CustomEditorUtility.DrawLine();

            CustomEditorUtility.DrawButton("Reset", () => RemoveNodes());
