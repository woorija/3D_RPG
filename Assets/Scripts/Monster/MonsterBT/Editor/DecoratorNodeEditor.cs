...
public class DecoratorNodeEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (showFoldout)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            CustomEditorUtility.DrawButtonStyleToggle("Success", null, (int)NodeList.Success, ref selectedIndex);
            CustomEditorUtility.DrawButtonStyleToggle("Failure", null, (int)NodeList.Failure, ref selectedIndex);
            ...
            EditorGUILayout.BeginHorizontal();
            CustomEditorUtility.DrawButtonStyleToggle("Die Preset", null, (int)NodeList.DiePreset, ref selectedIndex);
            CustomEditorUtility.DrawButtonStyleToggle("Stagger Preset", null, (int)NodeList.StaggerPreset, ref selectedIndex);
            EditorGUILayout.EndHorizontal();

            CustomEditorUtility.DrawButton("Apply Selection", () => ApplySelection());

            CustomEditorUtility.DrawLine();
            CustomEditorUtility.DrawButton("SetUp IfNode\n자식노드 3개필요", () => SetUpIfNode());
            CustomEditorUtility.DrawLine();
