...
{
    public static Dictionary<int, ItemBuffData> itemBuffDB = new Dictionary<int, ItemBuffData>();
    public static Dictionary<int, SkillBuffData> skillBuffDB = new Dictionary<int, SkillBuffData>();
    int isComplete = 0;
